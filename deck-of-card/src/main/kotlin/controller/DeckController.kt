...
class DeckController {
    ...
    public  fun drawCard(): Card{
        val cartas_resposta = HttpService.getJson(DeckOfCardsAPIConstants.getOneCardUrl(this.deck.deckId))
        val valores_das_cartas = cartas_resposta["cards"] as JSONArray
